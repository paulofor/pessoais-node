...
export class MetaApi extends BaseLoopBackApi {
  ...
  /**
   * Busca relação gerProjEntregaprojeto de belongsTo.
   *
   * @param {any} id Meta id
   *
   ...
   * </em>
   */
  public getGerProjEntregaprojeto(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Meta/:id/gerProjEntregaprojeto";
