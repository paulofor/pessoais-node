...
export class GerProj_ProjetoPmbokApi extends BaseLoopBackApi {
  ...
  /**
   * Localize um item relacionado por ID para gerProjEntregaprojetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjEntregaprojetos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdGerProjEntregaprojetos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Excluir um item relacionado por ID para gerProjEntregaprojetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjEntregaprojetos
   ...
   * This method returns no data.
   */
  public destroyByIdGerProjEntregaprojetos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Atualizar um item relacionado por ID para gerProjEntregaprojetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjEntregaprojetos
   ...
   * </em>
   */
  public updateByIdGerProjEntregaprojetos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Busca relação gerProjEntregaProjetoAtual de belongsTo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getGerProjEntregaProjetoAtual(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaProjetoAtual";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Localize um item relacionado por ID para gerProjAlocacaotempos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjAlocacaotempos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdGerProjAlocacaotempos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Excluir um item relacionado por ID para gerProjAlocacaotempos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjAlocacaotempos
   ...
   * This method returns no data.
   */
  public destroyByIdGerProjAlocacaotempos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Atualizar um item relacionado por ID para gerProjAlocacaotempos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para gerProjAlocacaotempos
   ...
   * </em>
   */
  public updateByIdGerProjAlocacaotempos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Busca relação gerProjProdutoestrategico de belongsTo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {boolean} refresh 
   ...
   * </em>
   */
  public getGerProjProdutoestrategico(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjProdutoestrategico";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Localize um item relacionado por ID para meta.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para meta
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdMeta(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Excluir um item relacionado por ID para meta.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para meta
   ...
   * This method returns no data.
   */
  public destroyByIdMeta(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta/:fk";
    let _routeParams: any = {
  ...
  /**
   * Atualizar um item relacionado por ID para meta.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para meta
   ...
   * </em>
   */
  public updateByIdMeta(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta/:fk";
    let _routeParams: any = {
  ...
  /**
   * Localize um item relacionado por ID para objetivoProjetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para objetivoProjetos
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdObjetivoProjetos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Excluir um item relacionado por ID para objetivoProjetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para objetivoProjetos
   ...
   * This method returns no data.
   */
  public destroyByIdObjetivoProjetos(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos/:fk";
    let _routeParams: any = {
  ...
  /**
   * Atualizar um item relacionado por ID para objetivoProjetos.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {any} fk Chave estrangeira para objetivoProjetos
   ...
   * </em>
   */
  public updateByIdObjetivoProjetos(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos/:fk";
    let _routeParams: any = {
  ...
  /**
   * gerProjEntregaprojetos consultas de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getGerProjEntregaprojetos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Cria uma nova instância no gerProjEntregaprojetos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createGerProjEntregaprojetos(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos";
    let _routeParams: any = {
  ...
  /**
   * Exclui todos os gerProjEntregaprojetos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteGerProjEntregaprojetos(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos";
    let _routeParams: any = {
  ...
  /**
   * gerProjEntregaprojetos contagens de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countGerProjEntregaprojetos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * gerProjAlocacaotempos consultas de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getGerProjAlocacaotempos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Cria uma nova instância no gerProjAlocacaotempos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createGerProjAlocacaotempos(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos";
    let _routeParams: any = {
  ...
  /**
   * Exclui todos os gerProjAlocacaotempos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteGerProjAlocacaotempos(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos";
    let _routeParams: any = {
  ...
  /**
   * gerProjAlocacaotempos contagens de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countGerProjAlocacaotempos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * meta consultas de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getMeta(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Cria uma nova instância no meta deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createMeta(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta";
    let _routeParams: any = {
  ...
  /**
   * Exclui todos os meta deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteMeta(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta";
    let _routeParams: any = {
  ...
  /**
   * meta contagens de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countMeta(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * objetivoProjetos consultas de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} filter 
   ...
   * </em>
   */
  public getObjetivoProjetos(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Cria uma nova instância no objetivoProjetos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createObjetivoProjetos(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos";
    let _routeParams: any = {
  ...
  /**
   * Exclui todos os objetivoProjetos deste modelo.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteObjetivoProjetos(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos";
    let _routeParams: any = {
  ...
  /**
   * objetivoProjetos contagens de GerProj_ProjetoPmbok.
   *
   * @param {any} id GerProj_ProjetoPmbok id
   *
   * @param {object} where Criteria to match model instances
   ...
   *  - `count` – `{number}` - 
   */
  public countObjetivoProjetos(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public AtualizaConsumo(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/atualizaConsumo";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public TotalDiaCorrente(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/totalDiaCorrente";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaMesmoGrupo(idProjeto: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/listaMesmoGrupo";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
   ...
   * </em>
   */
  public AtualizaAtual(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/atualizaAtual";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public LigaDesligaProjeto(idProjeto: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/ligaDesligaProjeto";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idProjeto !== 'undefined' && idProjeto !== null) _urlParams.idProjeto = idProjeto;
   ...
   * </em>
   */
  public CalculaTempoProjetos(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/calculaTempoProjetos";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public LigaDesligaTempoCompleto(idProjeto: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/ligaDesligaTempoCompleto";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idProjeto !== 'undefined' && idProjeto !== null) _urlParams.idProjeto = idProjeto;
   ...
   * </em>
   */
  public LigaDesligaExecutando(idProjeto: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/ligaDesligaExecutando";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof idProjeto !== 'undefined' && idProjeto !== null) _urlParams.idProjeto = idProjeto;
   ...
   * </em>
   */
  public FinalizaDia(customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/finalizaDia";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaExecucaoHojePlanejada(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/listaExecucaoHojePlanejada";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public ListaExecucaoHojeNaoPlanejada(customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/listaExecucaoHojeNaoPlanejada";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
   ...
   * </em>
   */
  public createManyGerProjEntregaprojetos(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjEntregaprojetos";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyGerProjAlocacaotempos(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/gerProjAlocacaotempos";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyMeta(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/meta";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyObjetivoProjetos(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/GerProj_ProjetoPmboks/:id/objetivoProjetos";
    let _routeParams: any = {
